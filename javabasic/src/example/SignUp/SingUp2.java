...
public class SingUp2 {
	...
	static String userPassword= new String();
	static String userPasswordCheck= new String();
	...
	public static void main(String[] args) {
		 ...
		 // <= 다차원 배열이다. Stirng 자체가 이미 문자 배열 이기 때문에 배열에 배열이기 때문. String의 특이성.
	...
	// 1. 사용자로부터 아이디, 패스워드, 패스워드 확인, 이름을 입력받음
		...
		idList = (ArrayList<String>) List.of("qwer", "asdf", "zxcv");
		...
		userPasswordCheck = scanner.nextLine();
